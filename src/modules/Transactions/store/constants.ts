...
export const ADD_SELECTED_TRANSACTION = `${SCOPENAME}/ADD_SELECTED_TRANSACTION`;
export const REMOVE_SELECTED_TRANSACTION = `${SCOPENAME}/REMOVE_SELECTED_TRANSACTION`;
export const CLEAR_SELECTED_TRANSACTION = `${SCOPENAME}/CLEAR_SELECTED_TRANSACTION`;
